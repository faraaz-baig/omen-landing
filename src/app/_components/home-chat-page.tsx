...
export function HomeChatPage() {
  ...
  const handleSubmit = useCallback(
    (text: string) => {
      ...
      router.push(`/preview/chat/${provisionalChatId}`, { scroll: false });
    },
    [
      requestSignIn,
      router,
        ...
        <div className="flex min-h-0 flex-1 items-center justify-center pb-20 sm:pb-[12vh]">
          <div className="w-full max-w-2xl space-y-5 sm:space-y-7 md:space-y-8">
            <h1 className="flex justify-center">
              <span className="text-[13px] font-medium tracking-[0.35em] uppercase select-none">Omen</span>
            </h1>
            <ChatComposer
              autoFocus
              ...
              placeholder="Ask about a medication, a gene, or a condition..."
              value={draft}
            />
          </div>
        </div>
