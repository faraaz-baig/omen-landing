 ...
 * hero frame on desktop — the page opens with a framed photograph and closes
 * with a framed dark surface, same radius, same inset. On mobile it runs
 * full-bleed and flush with the bottom edge, like the hero image. Espresso
 * rather than --ink: the panel belongs to the golden photography above it,
 * not to the cool text color.
 *
...
export function SiteFooter() {
  return (
    <footer className="sm:px-5 sm:pb-5">
      <div className="bg-espresso px-6 pt-9 pb-6 sm:rounded-[var(--radius-frame)] sm:px-16 sm:pt-12 sm:pb-8">
        <div className="flex flex-col gap-7 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <OmenMark className="h-5 w-auto text-paper" />
