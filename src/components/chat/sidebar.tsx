...
export function ChatSidebar({
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-1 px-2 pt-2 pb-2">
        <div className="flex items-center justify-between">
          <button
            ...
            className="flex h-8 items-center justify-center rounded-md px-1 text-muted-foreground transition-colors hover:bg-muted/60 hover:text-foreground"
            onClick={() => {
              onNewChat();
              onNavigate?.(null);
            }}
            type="button"
          >
            <span className="text-[11px] font-medium tracking-[0.18em] uppercase">Omen</span>
          </button>
          {onToggleSidebar ? (
            <Button
        ...
        <a
          className="flex h-8 items-center gap-2 rounded-md px-2 text-left text-sm text-muted-foreground transition-colors hover:bg-muted/60 hover:text-foreground"
          href="/preview/genome"
        >
      ...
      {setupStatus.authMode === "local-dev" ? null : (
